// Port of DCourt/Static/QuestStrings.java
...
export const answer = [
  'A heart.', 'Man', 'To eat the puny mortal?', 'They have two left feet.',
  "There's a hole in your pocket.", 'An arrow', 'A river', 'My name.', 'Shake hands.',
  "The letter 'M'", 'Fire', 'Footsteps', 'A splinter.',
]

export const guess = [
  'Uh... Reaganomics?', 'Oatmeal!', 'A power drill....', 'Fine china.', 'Lipo-suction?',
  'Green marbles, no - red ones!', 'The Elephant Man?', 'Was it Elvis?', 'Fire ants!', 'Thailand.',
  'Spitting?', "Fred's Friends, Inc. --right?", 'Uhhh.... Uhhh.... Uh-oh...', 'I used to know that one...',
  'Could you repeat that?', 'I think I hear my mother calling.', 'Beetlegoose! Beetlegoose!, Beetlegoose!',
  'A bottle nosed dolphin.', 'An indian head penny.', 'My sword in your gullet!',
]

export const seduces = [
